...
classes_ja = ["Ｔシャツ／トップ", "ズボン", "プルオーバー", "ドレス", "コート", "サンダル", "ワイシャツ", "スニーカー", "バッグ", "アンクルブーツ"]
classes_en = ["T-shirt/top", "Trouser", "Pullover", "Dress", "Coat", "Sandal", "Shirts", "Sneaker", "Bag", "Ankle boot"]
...
def predict(img):
  ...
  img = img.resize((img_size, img_size)) 画像サイズ変換
  ...
  y = net(x)
  #結果を返す
  y_prob = torch.nn.functional.softmax(torch.squeeze(y)) #確率表示
